	...
	return mymodels.AllTest{
		{
			...
			Function:     activities.CasesGetAllActivities,
			Body:         "",
	...
	return mymodels.AllTest{
		{
			...
			ExpectedBody: `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","Type":"Calificable","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "POST",
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","CourseID":1,"ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"HCNID":1,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/UpdateActivity",
			Function:     activities.UpdateActivity,
			Body:         `{"ID":1,"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3}`,
	...
	return mymodels.AllTest{
		{
			...
			ExpectedBody: `{"ID":3"Title":"Creando mi primera tarea","Description":"Re difficult mai friennd","Type":"Calificable","LimitDate":"2021-01-20 23:30:00","CourseID":1,"ClinicalCaseID":2,"HCNID":1,"Difficulty":3}`,
		...
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
			ExpectedBody: `CreationDate is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","CourseID":1,"ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
			ExpectedBody: `LimitDate is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","ClinicalCaseID":3,"HCNID":1,"Difficulty":3}`,
			ExpectedBody: `CourseID is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"HCNID":1,"Difficulty":3}`,
			ExpectedBody: `ClinicalCaseID is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3,"Difficulty":3}`,
			ExpectedBody: `HCNID is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
		{
			...
			URL:          "/Activities/CreateActivity",
			Function:     activities.CreateActivity,
			Body:         `{"Title":"Primera tarea rey, matrices dispersas","Description":"Re easy pri, solo busquen en Google.","CreationDate":"2021-01-08 12:00:00","LimitDate":"2021-01-10 12:00:00","CourseID":1,"ClinicalCaseID":3}`,
			ExpectedBody: `Difficulty is empty or not valid`,
			StatusCode:   http.StatusBadRequest,
		},
	}
	...
	return mymodels.AllTest{
		{
			...
			Function:     activities.DeleteAnnouncement,
			Body:         `{"ID":10}`,
