	...
	return mymodels.AllTest{
		{
			...
			Body:         "",
			ExpectedBody: `[{"ID":1,"TeacherID":1,"MongoID":"602dbcd2437d1bc1295d976e"},{"ID":2,"TeacherID":1,"MongoID":"5tgdfdghghdfdbc1295d976d"},{"ID":3,"TeacherID":1,"MongoID":"dfvdbcd2437sfbc1295d54de"},{"ID":4,"TeacherID":2,"MongoID":"nhddbcd2437d1bc8fvewigd3"},{"ID":5,"TeacherID":3,"MongoID":"knv949f95dvreij9mvo00dmd"}]`,
...
func CasesGetHCN() mymodels.AllTest {
	return mymodels.AllTest{
		...
		},
		{
			...
			Function:     hcn.GetHCN,
			Body:         "",
			ExpectedBody: `{"ID":1,"TeacherID":1,"MongoID":"602dbcd2437d1bc1295d976e"}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "GET",
			...
			Function:     hcn.GetHCN,
			Body:         "",
			ExpectedBody: `{"ID":2,"TeacherID":1,"MongoID":"5tgdfdghghdfdbc1295d976d"}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "GET",
			...
			Function:     hcn.GetHCN,
			Body:         "",
			ExpectedBody: `{"ID":3,"TeacherID":1,"MongoID":"dfvdbcd2437sfbc1295d54de"}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "GET",
	...
	return mymodels.AllTest{
		{
			...
			Body:         `{"ID":1,"TeacherID":2,"MongoID":"EstaEsun4Prueb4"}`,
			ExpectedBody: `{"ID":1,"TeacherID":2,"MongoID":"EstaEsun4Prueb4"}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "POST",
			URL:          "/HCN/UpdateHCN",
			Function:     hcn.UpdateHCN,
			Body:         `{"ID":1,"TeacherID":1,"MongoID":"EstaEsNoun4Prueb4"}`,
			ExpectedBody: `{"ID":1,"TeacherID":1,"MongoID":"EstaEsNoun4Prueb4"}`,
			StatusCode:   http.StatusOK,
		},
		{
			Method:       "POST",
			URL:          "/HCN/UpdateHCN",
			Function:     hcn.UpdateHCN,
			Body:         `{"ID":11,"TeacherID":2,"MongoID":"EstaEsNoun4Prueb4"}`,
	...
	return mymodels.AllTest{
		{
			...
			Body:         `{"TeacherID": 1,"MongoID": "EstaEsun4Prueb4"}`,
			ExpectedBody: `{"ID":6,"TeacherID":1,"MongoID":"EstaEsun4Prueb4"}`,
		...
		},
		{
			...
			URL:          "/HCN/CreateHCN",
			Function:     hcn.CreateHCN,
			Body:         `{"TeacherID":2,"MongoID":"EstaEsun4Prueb4"}`,
			ExpectedBody: `{"ID":7,"TeacherID":2,"MongoID":"EstaEsun4Prueb4"}`,
			StatusCode:   http.StatusCreated,
		},
		{
			Method:       "POST",
